...
export const QUESTIONS_FORMAL: Record<string, TopicQ> = {
  security: {
    ...
    options: [
      ...
      {
        id: "peace",
        text: "פתרון מדיני — רק הסדר קבוע עם הפלסטינים יוציא את ישראל מהלופ של מלחמות",
  ...
  education: {
    ...
    options: [
      ...
      { id: "equal",   text: "שוויון — כל ילד מקבל אותה הזדמנות, ללא קשר לרקע שלו",           scores: [2, 2, 1, 1, 1, 0, -1] },
  ...
  justice: {
    ...
    options: [
      ...
      { id: "oversight",    text: "ביקורת — גם בית המשפט צריך גורם שיאזן אותו",           scores: [-1, -1, -1, 0, 0, 2, 2] },
      { id: "consensus",    text: "יציבות — שינויים משפטיים יתקבלו רק בהסכמה רחבה",               scores: [1, 1, 1, 2, 1, 0, 0] },
