...
2. **Cost driver**: score-topics is 40% of token spend. Reducing the party-platform excerpts passed per call (e.g. only sending relevant parties' excerpts, not all 13) would cut costs proportionally.
