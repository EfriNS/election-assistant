...
## Parties Covered (September 2026)

הרשימה המשותפת (חד"ש-תע"ל-בל"ד) · רע"מ · הדמוקרטים · ביחד (בנט/לפיד) · ישר! (איזנקוט) · המילואימניקים-הכלכלית (הנדל/זליכה) · ישראל ביתנו · ליכוד · עמך ישראל (וינטר) · ש"ס · יהדות התורה · הציונות הדתית (סמוטריץ') · עוצמה יהודית
