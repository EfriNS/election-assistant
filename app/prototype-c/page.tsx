...
const DILEMMAS = [
  ...
  },
  {
    id: 2,
    topic: "ביטחון",
    question: "בנושא עתיד עזה, הממשלה עומדת בפני בחירה:",
    optionA: { label: "לחץ צבאי", text: "להמשיך בלחימה עד להשגת כל יעדי המלחמה" },
    optionB: { label: "הסכם מיידי", text: "לקדם הסכם לשחרור החטופים גם במחיר הפסקת לחימה מהירה" },
  },
  {
    id: 3,
    topic: "גיוס",
