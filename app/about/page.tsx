    ...
    <main className="min-h-screen flex flex-col items-center px-4 py-16" dir="rtl">
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <section className="space-y-2">
          ...
          <p className="text-sm text-gray-600 leading-relaxed">
            תחומי המדיניות שנכללים בשאלון נבחרו ידנית. שאלות הפתיחה בכל תחום נוסחו ידנית; בהתאם לתשובות ולאורך השאלון המבוקש, המערכת יכולה ליצור שאלות המשך בסיוע בינה מלאכותית (מודל Gemini של Google). ניקוד ההתאמה בין תשובותיך למצעי המפלגות נעשה גם הוא בסיוע אותו מודל.
          </p>
          <p className="text-sm text-gray-600 leading-relaxed">
            חשוב להבהיר: ההתאמה נמדדת מול מה שמפלגה כותבת ומצהירה באופן רשמי — לא מול האופן שבו היא פעלה בעבר בשלטון או בקואליציה, ולא מול מהימנות חבריה. מסמך רשמי, גם כשהוא עדכני, אינו ערובה להתנהלות בפועל.
          </p>
        </section>
