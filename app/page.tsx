    ...
    <main className="min-h-screen flex flex-col items-center px-4 py-16">
      <div className="w-full max-w-md">
        ...
        <div className="bg-gray-50 rounded-xl p-4 mb-8 text-xs text-gray-500 leading-relaxed space-y-1.5">
          ...
          <p><strong className="text-gray-700">על בסיס מה?</strong> ציוני ההתאמה מחושבים על פי מצעי המפלגות ומסמכי עמדה רשמיים, בסיוע בינה מלאכותית. לכל ציטוט מצורף קישור למקור. מפלגות שאין להן מצע רשמי מסומנות בפירוש — ובמקרה זה נעשה שימוש במקורות האמינים ביותר שמצאנו.</p>
          <p><strong className="text-gray-700">פרטיות.</strong> התשובות אינן נשמרות ואינן מקושרות אליכם. הכלי עצמאי וניטרלי — ללא מימון או שיוך לאף מפלגה, ואינו ממליץ על מפלגה או מחזיק בעמדה פוליטית.</p>
        </div>
