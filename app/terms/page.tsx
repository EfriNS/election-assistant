    ...
    <main className="min-h-screen flex flex-col items-center px-4 py-16" dir="rtl">
      <div className="w-full max-w-md space-y-8">
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-gray-600 leading-relaxed">
            הכלי אינו קשור, ממומן, או פועל מטעם אף מפלגה. שמות המפלגות מוזכרים לצורך זיהוי והשוואה בלבד, ואין בכך משום אישור, שיוך או פעולה מטעם מי מהן.
          </p>

          <p className="text-sm text-gray-600 leading-relaxed">
            הציטוטים ממצעי המפלגות מבוססים על מקורות רשמיים במידת האפשר, עם קישור למקור לכל ציטוט. ציוני ההתאמה וניתוחי הטקסט נוצרים בסיוע בינה מלאכותית — מודל Gemini של Google — ומשקפים את הניתוח של הכלי, לא הצהרה של המפלגה עצמה על עצמה.
          </p>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-gray-600 leading-relaxed">
            לצורך יצירת שאלות ההמשך וחישוב ציוני ההתאמה, התשובות נשלחות לעיבוד למודל הבינה המלאכותית Gemini של Google — ללא שם, פרטי קשר או כל פרט מזהה אחר. עיבוד זה כפוף לתנאי השימוש ולמדיניות הפרטיות של Google.
          </p>
