...
- כאשר אתה מציג אפשרויות אפשריות לתשובה, הצג כל אפשרות בשורה נפרדת עם מספר (1. ... 2. ... 3. ...), והוסף בסוף: "4. אחר — ספר לי בחופשיות". המשתמש יכול לבחור אפשרות או לכתוב כל תשובה חופשית.
