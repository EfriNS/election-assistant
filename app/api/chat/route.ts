...
- אחרי כ-8-10 נושאים, סכם את עמדות המשתמש ותן תוצאה: דרג את המפלגות הבאות לפי קרבה לעמדות המשתמש: חד"ש-תע"ל, העבודה, יש עתיד, המחנה הממלכתי, ישראל ביתנו, ליכוד, ש"ס.
